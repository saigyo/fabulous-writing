...
## Backlog — moved to GitHub issues (2026-07-28)

Decisions made deliberately during milestone work, recorded so they are not
rediscovered as bugs. With M6 closing the milestone series, the backlog moved
to GitHub issues (label `backlog`) — the full item text, deferral rationale,
and constraints live in the issue bodies verbatim; new ideas are filed there
directly, and pickup re-enters the usual spec → plan → review → PR workflow.

- B1 per-user UI preference survival — moved to [#34](https://github.com/saigyo/fabulous-writing/issues/34)
- B2 informal UI register — moved to [#35](https://github.com/saigyo/fabulous-writing/issues/35)
- B3 proper dialog pattern (+ admin own-row reset UX) — moved to [#36](https://github.com/saigyo/fabulous-writing/issues/36)
- B4 landing-page treatment for the login gate — moved to [#37](https://github.com/saigyo/fabulous-writing/issues/37)
- B5 failure classification on the `llm_usage` ledger — moved to [#38](https://github.com/saigyo/fabulous-writing/issues/38)
- B6 credit-based LLM budgeting — moved to [#40](https://github.com/saigyo/fabulous-writing/issues/40)
- B7 provider usage reporting — moved to [#39](https://github.com/saigyo/fabulous-writing/issues/39)
- B8 test-suite speedup, remaining levers (core DONE in PR #31) — moved to [#41](https://github.com/saigyo/fabulous-writing/issues/41)
- B9 save-failure surfacing in the editor — moved to [#42](https://github.com/saigyo/fabulous-writing/issues/42)
