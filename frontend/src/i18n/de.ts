...
export const de: Messages = {
  ...
  accountActivity: 'Meine Aktivität',
  activityTitleAll: 'Aktivität aller Nutzer',
  activityRuns: 'Läufe pro Tag',
  activityTokens: 'Tokens pro Tag',
  activityCredits: 'Credits pro Tag',
  activityCheck: 'Prüfung',
  activitySuggestion: 'Vorschlag',
  activityName: 'Benennung',
  activityFailed: 'fehlgeschlagen',
  activityInput: 'Eingabe',
  activityOutput: 'Ausgabe',
  activityDays30: '30 Tage',
  activityDays90: '90 Tage',
  activityDays365: '365 Tage',
  activityTotalRuns: 'Läufe',
  activityTableUser: 'Nutzer',
  ...
  resetRequestSent:
    'Falls es zu dieser Adresse ein Konto gibt, ist ein Link zum Zurücksetzen unterwegs.',
  resetHeading: 'Wähle ein neues Passwort',
  inviteHeading: 'Willkommen! Wähle dein Passwort',
  ...
  resetSuccess: 'Dein Passwort ist gespeichert — du kannst dich jetzt anmelden.',
  resetBackToSignIn: 'Zur Anmeldung',
  resetLinkInvalid: 'Dieser Link ist ungültig oder abgelaufen. Fordere einen neuen an.',
  resetAccountInactive: 'Dieses Konto ist deaktiviert — wende dich an deinen Admin.',
  resetEmailLabel: 'Deine E-Mail-Adresse',
  ...
  adminUserInactive: 'Dieses Konto ist deaktiviert.',
