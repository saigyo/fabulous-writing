...
export const fr: Messages = {
  ...
  accountActivity: 'Mon activité',
  activityTitleAll: 'Activité de tous les utilisateurs',
  activityRuns: 'Exécutions par jour',
  activityTokens: 'Tokens par jour',
  activityCredits: 'Crédits par jour',
  activityCheck: 'vérification',
  activitySuggestion: 'suggestion',
  activityName: 'nommage',
  activityFailed: 'échec',
  activityInput: 'entrée',
  activityOutput: 'sortie',
  activityDays30: '30 jours',
  activityDays90: '90 jours',
  activityDays365: '365 jours',
  activityTotalRuns: 'exécutions',
  activityTableUser: 'Utilisateur',
  activityTableCredits: 'Crédits',
  ...
  resetAccountInactive: 'Ce compte est désactivé — contacte ton admin.',
  ...
  adminResendInvite: "Renvoyer l'invitation",
  adminResendSent: 'Invitation renvoyée.',
  adminResendAlreadyActive: 'Ce compte est déjà actif — aucune invitation nécessaire.',
  adminUserInactive: 'Ce compte est désactivé.',
